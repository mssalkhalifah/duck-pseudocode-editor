...
public final class GrxParser {
    ...
    private static final Reductor[] reductions = {
        ...
        new Reductor() {
            @Override
            public Object reduce(Stack<StackEntry> _grx_stack) throws VariableDefinedException, InvalidTypeException, VariableUndefinedException {
                _grx_stack.pop();
                ...
                Object v;
                {
                SymbolTable.addSymbol((Token) id);
                v = SymbolTable.initAttributes((Token) id, type, (Token) value);
                }
                return v;
            }
        },
        ...
        new Reductor() {
            ...
            public Object reduce(Stack<StackEntry> _grx_stack) throws VariableUndefinedException, InvalidTypeException {
                ...
                Object v;
                {
                v = SymbolTable.updateAttribute((Token) unaryExp, (Token) assignOP, (Token) assignExp);
                }
                return v;
            }
        },
    ...
    private interface Reductor {
        Object reduce(Stack<StackEntry> _grx_stack) throws VariableUndefinedException, InvalidTypeException, VariableDefinedException;
    }
    public GrxParser() {
        stack = new Stack<>();
    ...
    public void parse(int tokenId, Object tokenPayload) throws VariableUndefinedException, VariableDefinedException, InvalidTypeException {
        while (true) {
            ...
            if (action == 0) {
                int line = ((Token) tokenPayload).getLineNumber() + 1;
                int column = ((Token) tokenPayload).getColumnNumber() + 1;
                throw new RuntimeException(String.format("%d:%d-Syntax error", line, column));
            }
            if (action == -1) {
