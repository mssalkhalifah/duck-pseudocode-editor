...
%public
%class DuckTokenMaker
%extends AbstractJFlexCTokenMaker
%unicode
%type org.fife.ui.rsyntaxtextarea.Token

/**
 * Token Maker class for the duck programming language.
 */
...
%{
    ...
    *   
    * All internal variables are rest, the old input stream    
...
IntegralConst				= {Digit}+
ErrorNumberFormat			= ({IntegralConst})({NonSeparator})+
...
<YYINITIAL> {
    ...
    // Functions
    "output"		{addToken(Token.FUNCTION);}
    ...
    // Numbers.   
    {IntegralConst}         	{ addToken(Token.LITERAL_NUMBER_DECIMAL_INT); }   
